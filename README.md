...
Старонка захоўвае паміж сесіямі апошнія настройкі камвертара. Але каб захаваць, трэба выканаць канвертацыю.
